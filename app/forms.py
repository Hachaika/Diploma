...
class TaskForm(FlaskForm):
    ...
    p1_sp13 = IntegerField('P1 SP 13', default=0)
    p1_sp21 = IntegerField('P1 SP 21', default=0)
    ...
    p2_sp13 = IntegerField('P2 SP 13', default=0)
    p2_sp21 = IntegerField('P2 SP 21', default=0)
    ...
    p3_sp13 = IntegerField('P3 SP 13', default=0)
    p3_sp21 = IntegerField('P3 SP 21', default=0)
    ...
    p4_sp13 = IntegerField('P4 SP 13', default=0)
    p4_sp21 = IntegerField('P4 SP 21', default=0)
